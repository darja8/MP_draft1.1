package com.example.mp_draft10.documents

const val termsAndConditions =
    "" +
            "Welcome to Moodify!\n" +
            "\n" +
            "These terms and conditions outline the rules and regulations for the use of Moodify.\n" +
            "\n" +
            "By using this app we assume you accept these terms and conditions. Do not continue to use Moodify if you do not agree to take all of the terms and conditions stated on this page.\n" +
            "\n" +
            ...
            "\n" +
            "License\n" +
            "Unless otherwise stated, Moodify and/or its licensors own the intellectual property rights for all material on Moodify. All intellectual property rights are reserved. You may access this from Moodify for your own personal use subjected to restrictions set in these terms and conditions.\n" +
            "\n" +
            "You must not:\n" +
            "\n" +
            "Republish material from Moodify\n" +
            "Sell, rent or sub-license material from Moodify\n" +
            "Reproduce, duplicate or copy material from Moodify\n" +
            "Redistribute content from Moodify\n" +
            "This Agreement shall begin on the date hereof.\n" +
            "\n" +
            "Parts of this app offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Moodify does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Moodify, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Moodify shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.\n" +
            "\n" +
            "Moodify reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.\n" +
            "\n" +
            ...
            "You hereby grant Moodify a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.\n" +
            "\n" +
            ...
            "We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Moodify; and (d) the link is in the context of general resource information.\n" +
            "\n" +
            ...
            "\n" +
            "If you are one of the organizations listed in paragraph 2 above and are interested in linking to our App, you must inform us by sending an e-mail to Moodify. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our App, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.\n" +
            "\n" +
            ...
            "No use of Moodify's logo or other artwork will be allowed for linking absent a trademark license agreement.\n" +
            "\n" +
            "iFrames\n" +
